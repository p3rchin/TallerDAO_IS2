...
public class EditSQLPersonPanel extends JPanel {
	...
	public void initialize() {
		...
		title = new JLabel("Edit person SQL");
		...
		editButton.setActionCommand("EDITPERSONSQLBUTTON");
		add(editButton);
		...
		returnButton.setActionCommand("RETURNEDITSQLBUTTON");
		add(returnButton);
	}
